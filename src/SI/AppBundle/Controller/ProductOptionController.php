...
class ProductOptionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('productoption/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('productoption/new.html.twig', array(
    ...
    public function showAction(ProductOption $productOption)
    {
        ...
        return $this->render('productoption/show.html.twig', array(
            'productOption' => $productOption,
    ...
    public function editAction(Request $request, ProductOption $productOption)
    {
        ...
        return $this->render('productoption/edit.html.twig', array(
            'productOption' => $productOption,
