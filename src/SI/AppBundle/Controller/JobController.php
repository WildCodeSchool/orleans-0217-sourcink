...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $jobs = $em->getRepository('SIAppBundle:Job')->findAll();
    ...
    {
        $job = new Job();
        $form = $this->createForm('SI\AppBundle\Form\JobType', $job);
    ...
    {
        $deleteForm = $this->createDeleteForm($job);
        $editForm = $this->createForm('SI\AppBundle\Form\JobType', $job);
