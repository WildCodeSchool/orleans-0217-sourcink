...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('SIAppBundle:Product')->findAll();
    ...
    {
        $product = new Product();
        $form = $this->createForm('SI\AppBundle\Form\ProductType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('SI\AppBundle\Form\ProductType', $product);
